<%@ Page Title="" Language="C#" MasterPageFile="~/principal.Master" AutoEventWireup="true" CodeBehind="estado_asignacion.aspx.cs" Inherits="EvaluacionG5.WEB.modulos.administracion.estado_asignacion" %>
        ...
        <div class="main" style="width: 100% !important;">
            <div class="cbp-mc-form" style="width: 95%; margin: 0 auto;">
                <div class="cbp-mc-1column">
                    <h1>
                        <asp:Literal ID="Literal16" runat="server" Text="<%$ Resources: titulos,_titEstadoAsignacion%>" />
                    </h1>
                </div>
            </div>
            <div class="cbp-mc-form" style="width: 95%; margin: 0 auto;">
                <div class="cbp-mc-10column quituple10">
                    <label><asp:Literal ID="Literal1" runat="server" Text="<%$ Resources: etiquetas,_etiNombreAsignacion%>" /></label>
                    <asp:TextBox ID="txtAsignacion" runat="server"></asp:TextBox>
                </div>
                <div class="cbp-mc-10column quituple10">
                    <label><asp:Literal ID="Literal2" runat="server" Text="<%$ Resources: etiquetas,_etiNombre%>" /></label>
                    <asp:TextBox ID="txtNombreEmpleado" runat="server" MaxLength="128"></asp:TextBox>
                </div>
            </div>
            <div class="cbp-mc-form" style="width: 95%; margin: 0 auto;">
                <div class="cbp-mc-1column">
                    ...
                    <asp:Button ID="btnConsular" runat="server" Text="<%$ Resources: etiquetas,_etiConsultar%>" CssClass="cbp-mc-success" OnClick="btnConsular_Click" />
                </div>
            </div>
                    ...
                    <asp:GridView ID="grdResultados" runat="server" AutoGenerateColumns="false">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="<%$ Resources: cabeceras,_cabNombre%>">
                                <ItemTemplate>
                                    <asp:Label ID="lblNombreAsignacion" runat="server" Text='<%# Bind("NOMINSTRUMENTOEMPLEADO") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$ Resources: cabeceras,_cabNombre%>">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="<%$ Resources: cabeceras,_cabNombre%>">
                                <ItemTemplate>
                                    <asp:Label ID="lblNombreEvaluador" runat="server" Text='<%# Bind("NOMBRE_EVALUADOR") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$ Resources: cabeceras,_cabApPaterno%>">
                                <ItemTemplate>
                                    <asp:Label ID="lblNombreVisador" runat="server" Text='<%# Bind("NOMBRE_VISADOR") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
