<%@ Page Title="" Language="C#" MasterPageFile="~/principal.Master" AutoEventWireup="true" CodeBehind="lista_instrumentos.aspx.cs" Inherits="EvaluacionG5.WEB.modulos.administracion.lista_instrumentos" %>
        ...
        <div class="main" style="width: 100% !important;">
            ...
            <div class="cbp-mc-form" style="width: 95%; margin: 0 auto;">
                <div class="cbp-mc-1column">
                    ...
                    <asp:Button ID="btnAgregarNuevo" runat="server" Text="<%$ Resources: etiquetas,_etiNuevo%>" CssClass="btn btn-primary" OnClick="btnAgregarNuevo_Click" />
                </div>
            </div>
                ...
                <div class="cbp-mc-1column">
                    <asp:GridView ID="grdResultados" runat="server" AutoGenerateColumns="false">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="<%$ Resources: cabeceras,_cabCodigo%>">
                                <ItemTemplate>
                                    <asp:Label ID="lblCodigo" runat="server" Text='<%# Bind("CODINSTRUMENTO") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$ Resources: cabeceras,_cabInstrumento%>">
                                <ItemTemplate>
                                    <asp:Label ID="lblNombre" runat="server" Text='<%# Bind("NOMBREINSTRUMENTO") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
