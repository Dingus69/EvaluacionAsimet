<%@ Page Title="" Language="C#" MasterPageFile="~/principal.Master" AutoEventWireup="true" CodeBehind="lista_asignaciones_partners.aspx.cs" Inherits="EvaluacionG5.WEB.modulos.administracion.lista_asignaciones_partners" %>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="<%$ Resources: cabeceras,_cabNombre%>">
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField ID="hdfCodTipoEval" runat="server" Value='<%# Bind("COD_TIPO_EVAL") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="<%$ Resources: cabeceras,_cabTipoEval%>">
                                <ItemTemplate>
                                    <asp:Label ID="lblNomTipoEval" runat="server" Text='<%# Bind("NOM_TIPO_EVAL") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
