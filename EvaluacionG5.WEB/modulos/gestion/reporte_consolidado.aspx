<%@ Page Title="" Language="C#" MasterPageFile="~/principal.Master" AutoEventWireup="true" CodeBehind="reporte_consolidado.aspx.cs" Inherits="EvaluacionG5.WEB.modulos.gestion.reporte_consolidado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        $(function () {$('#container').highcharts({chart: {type: 'column'},
            title: {text: 'Asignaciones'},subtitle: {text: 'Distibución de asignaciones por estado.'},
            xAxis: {type: 'Estados'},
            yAxis: {title: {text: 'Cantidad de asignaciones'}},
        ...
        <div class="main" style="width: 100% !important;">
            <div style="width: 100%; margin: 0px !important; padding: 0px !important;">
                ...
                <div class="cbp-mc-form" style="width: 100%; margin: 0px !important; padding: 0px !important;">
                    ...
                    <div runat="server" class="cbp-mc-10column double10" style="margin: 0px !important; padding: 0px !important;" id="divEmpresa" runat="server" visible="false">
                        <label>
                    ...
                    <div class="cbp-mc-10column double10" style="margin: 0px !important; padding: 0px !important;" id="divVisador" runat="server" visible="false">
                        <label>
                    ...
                    <div class="col-lg-2 col-xs-6">
                        ...
                        <div class="small-box bg-aqua">
                            <div class="inner">
                                ...
                                <p>
                                    <asp:Literal ID="litAsignadas" runat="server" Text="<%$ Resources: etiquetas,_etiAsignadas%>" />
                                </p>
                            </div>
                            <div class="icon">
                    ...
                    <div class="col-lg-2 col-xs-6">
                        ...
                        <div class="small-box bg-maroon">
                            <div class="inner">
                                ...
                                <p>
                                    <asp:Literal ID="litEnBorrador" runat="server" Text="<%$ Resources: etiquetas,_etiEnBorrador%>" />
                                </p>
                            </div>
                            <div class="icon">
                    ...
                    <div class="col-lg-2 col-xs-6">
                        ...
                        <div class="small-box bg-green">
                            <div class="inner">
                                ...
                                <p>
                                    <asp:Literal ID="litCerradas" runat="server" Text="<%$ Resources: etiquetas,_etiCerradas%>" />
                                </p>
                            </div>
                            <div class="icon">
                                <i class="ion ion-stats-bars"></i>
